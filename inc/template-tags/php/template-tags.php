...
///SHARING BUTTONS ////
function mastertheme_the_sharing_buttons(){

	global $post;
	$url_to_share=esc_attr(get_permalink($post->ID));
	?>
	<div class="mastertheme-sharing-buttons my-5" >
	
		<!-- Basic Share Links -->
		<span><?php _e( 'Share', 'mastertheme' ); ?>: &nbsp; </span>
 ...
 */
if(!function_exists('ts_social_media')):
function ts_social_media() {
	...
	if ( $facebook || $twitter  || $googleplus || $instagram || $youtube || $pinterest  ) { ?>
		<aside id="social-media" class="widget footer-widget">
	<?php }?>

	<?php if ( $facebook != '' ) { ?>
		<span class="facebook social-icon"><a href="<?php echo get_theme_mod( 'facebook' ); ?>">
				<img src="<?php echo get_stylesheet_directory_uri();?>/assets/images/fb.png" width="48" height="48"></a></span>
	<?php } ?>

	<?php if ( $instagram != '' ) { ?>
		<span class="instagram social-icon"><a href="<?php echo get_theme_mod( 'instagram' ); ?>">
				<img src="<?php echo get_stylesheet_directory_uri();?>/assets/images/instagram.png" width="48" height="48"></a></span>
	<?php } ?>

	<?php if ( $youtube != '' ) { ?>
		<span class="youtube social-icon"><a href="<?php echo get_theme_mod( 'youtube' ); ?>">
				<img src="<?php echo get_stylesheet_directory_uri();?>/assets/images/youtube.png" width="48" height="48"></a></span>
	<?php } ?>

	<?php  if( $twitter != '' ) { ?>
		<span class="twitter social-icon"><a href="<?php echo get_theme_mod( 'twitter' ); ?>">
				<img src="<?php echo get_stylesheet_directory_uri();?>/assets/images/twitter.png" width="48" height="48"></a></span>
	<?php }?>

	<?php  if( $googleplus != '' ) { ?>
		<span class="googleplus social-icon"><a href="<?php echo get_theme_mod( 'googleplus' ); ?>">
				<img src="<?php echo get_stylesheet_directory_uri();?>/assets/images/google.png" width="48" height="48"></a></span>
	<?php }?>

	<?php  if( $pinterest != '' ) { ?>
		<span class="pinterest social-icon"><a href="<?php echo get_theme_mod( 'pinterest' ); ?>">
				<img src="<?php echo get_stylesheet_directory_uri();?>/assets/images/pinterest.png" width="48" height="48"></a></span>
	<?php }?>
